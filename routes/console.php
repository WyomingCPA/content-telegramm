...
Schedule::command('app:get-post-from-telegramm-anime-video')->hourly()->runInBackground()->withoutOverlapping();
...
Schedule::command('app:queue-anime-video-telegramm')->everyTenMinutes()->runInBackground()->withoutOverlapping();
